...
!function(e){var n,t,i=e.event;n=i.special.debounce={setup:function(){e(this).on("resize",n.handler)},teardown:function(){e(this).off("resize",n.handler)},handler:function(e,o){var r=this,h=arguments,s=function(){e.type="debounce",i.dispatch.apply(r,h)};t&&clearTimeout(t),o?s():t=setTimeout(s,n.threshold)},threshold:150}}(jQuery);
